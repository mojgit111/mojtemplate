...
import 'package:ecommerce_mobile/providers/spaseni_provider.dart';
...
void main() {
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider<ProizvodiKomentariProvider>(
        create: (context) => ProizvodiKomentariProvider()),
    ChangeNotifierProvider<ProductTypeProvider>(
        create: (context) => ProductTypeProvider()),
    ChangeNotifierProvider<CartProvider>(create: (context) => CartProvider()),
    ChangeNotifierProvider<SpaseniProvider>(
        create: (context) => SpaseniProvider()),
          ChangeNotifierProvider<IspitProvider>(
        create: (context) => IspitProvider()),
