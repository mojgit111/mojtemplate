...
void main() {
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider<ProductTypeProvider>(
        ...
        ChangeNotifierProvider<ProizvodKomentariProvider>(
        create: (context) => ProizvodKomentariProvider()),
         ChangeNotifierProvider<IspitProvider>(
        create: (context) => IspitProvider()),
           ChangeNotifierProvider<KomentariProizvodProvider>(
        create: (context) => KomentariProizvodProvider()),
