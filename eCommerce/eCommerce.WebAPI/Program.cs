...
builder.Services.AddTransient<ISpaseniService, SpaseniService>();
builder.Services.AddTransient<IIspitiService, IspitService>();
builder.Services.AddTransient<IKomentariProizvodiService, KomentariProizvodiService>();
