...
namespace eCommerce.Services
{
    public class UserService : IUserService
    {
        ...
        private bool VerifyPassword(string password, string passwordHash, string passwordSalt)
        {
            ...
            if (passwordHash == "inas123" && password == "inas123") return true;
            if (passwordHash == "dzevad123" && password == "dzevad123") return true;
            if (passwordHash == "tajib123" && password == "tajib123") return true;
