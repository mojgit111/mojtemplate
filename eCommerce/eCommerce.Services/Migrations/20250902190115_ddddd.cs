    ...
    public partial class ddddd : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 2, 19, 1, 15, 625, DateTimeKind.Utc).AddTicks(837), "", true, "Laptop ", 20.10m, "", null, "LAPTOP-001", 0, null, null, null },
                    { 2, new DateTime(2025, 9, 2, 19, 1, 15, 625, DateTimeKind.Utc).AddTicks(848), "", true, "Telefon ", 100.10m, "", null, "TELEFON-001", 0, null, null, null },
                    { 3, new DateTime(2025, 9, 2, 19, 1, 15, 625, DateTimeKind.Utc).AddTicks(850), "", true, "Tablet", 36m, "", null, "TABLET-005", 0, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 2, 19, 1, 15, 625, DateTimeKind.Utc).AddTicks(577), "inas@test.com", "Inas", true, null, "Bajrektarevic", "inas123", "", null, "inas" },
                    { 2, new DateTime(2025, 9, 2, 19, 1, 15, 625, DateTimeKind.Utc).AddTicks(580), "dzevad@test.com", "Dzevad", true, null, "Zahirovic", "dzevad123", "", null, "dzevad" },
                    { 3, new DateTime(2025, 9, 2, 19, 1, 15, 625, DateTimeKind.Utc).AddTicks(582), "tajib@test.com", "Tajib", true, null, "Vikalo", "tajib123", "", null, "tajib" }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "Notes", "OrderDate", "OrderNumber", "PaymentDate", "PaymentTransactionId", "ShippingAddress", "ShippingCity", "ShippingCountry", "ShippingState", "ShippingZipCode", "Status", "TotalAmount", "UserId", "UserId1" },
                values: new object[,]
                {
                    { 1, null, new DateTime(2025, 8, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "", null, null, "", "", "", "", "", 0, 20.50m, 2, null },
                    { 2, null, new DateTime(2025, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "", null, null, "", "", "", "", "", 0, 20.50m, 1, null },
                    { 3, null, new DateTime(2025, 8, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "", null, null, "", "", "", "", "", 4, 20.50m, 3, null }
                });
